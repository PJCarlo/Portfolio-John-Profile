import { EXPERIENCES, DESIGN, PROJECTS } from "../constants";
import { fadeIn } from "../constants/variants";
import { motion } from "framer-motion";

const Skills = () => {
  return (
    <div className="border-b border-neutral-900 pb-5 lg:pb-10">
      <motion.h1 
        variants={fadeIn('down', 0)}
        initial="hidden"  
        whileInView="visible"
        viewport={{once: false, amount: 0}}
        className="my-15 text-center text-4xl">Experience
      </motion.h1>
      <div>
      ...
      <motion.h1 
        ...
        whileInView="visible"
        viewport={{once: false, amount: 0}}
        className="lg:pt-10 my-15 text-center text-4xl">Design
      </motion.h1>
      <div>
          ...
          <div key={index} className="pb-8 flex flex-wrap lg:justify-center">
            <motion.div 
              ...
              className="w-full lg:w-1/4">
                <p className="mb-2 text-sm text-neutral-400">{design.date}</p>
            </motion.div>
            <div className="w-full max-w-xl lg:w-3/4">
              <motion.h6 
                variants={fadeIn('left', 0.4 + index * 0.1)}
                ...
                whileInView="visible"
                viewport={{once: false, amount: 0}}
                className="mb-2 font-semibold">{design.title}
              </motion.h6>
              <motion.p 
                variants={fadeIn('left', 0.5 + index * 0.1)}
                initial="hidden"
                whileInView="visible"
                viewport={{once: false, amount: 0}}
                className="mb-4 text-sm text-neutral-400">{design.description}
              </motion.p>
              {design.technology.map((tech, index) => (
                <motion.span
                  variants={fadeIn('down', 0.6 + index * 0.1)}
                  initial="hidden"
                  whileInView="visible"
      ...
      <motion.h1 
        ...
        whileInView="visible"
        viewport={{once: false, amount: 0}}
        className="lg:pt-3 my-15 text-center text-4xl">Projects
      </motion.h1>
      <div>
